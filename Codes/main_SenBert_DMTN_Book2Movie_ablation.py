...
if __name__=="__main__":
	# ------PREPARE DATASET------#
	source_data_list, target_data_list, kg_data_list = torch.load("Data/formatData_Book2Movie_SenBert_V1T2.pt")
	...
	torch.save(model.state_dict(), "Data/save_DMTN_epoch_Book2Movie_" + str(args.lr) + str(args.model) + args.ablation_model + args.data_version + '.pth')
	...
	with open("Data/save_DMTN_epoch_Book2Movie_" + str(args.lr) + '_' +str(args.batch_size) + str(args.model) + args.ablation_model + args.data_version +'.txt', 'w') as f:
		for ii in range(K_folds):
